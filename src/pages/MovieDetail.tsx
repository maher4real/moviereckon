      ...
      <div className="container mx-auto px-4 -mt-48 md:-mt-64 relative z-10 pb-12">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Meta Info */}
            <div className="mb-6 rounded-xl border border-border/70 bg-card/55 p-3 md:p-4 backdrop-blur-sm">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="rounded-lg border border-border/70 bg-background/50 px-3 py-2.5">
                  ...
                  <p className="mt-1 text-sm md:text-base font-semibold text-foreground">
                ...
                >
                  <div className="flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
                    <Star className={cn("w-3.5 h-3.5", movie.vote_average > 0 && "text-primary fill-current")} />
                    Rating
                  </div>
                  <p className="mt-1 text-sm md:text-base font-semibold text-foreground">
                    {movie.vote_average > 0
