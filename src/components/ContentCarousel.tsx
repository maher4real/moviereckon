...
export default function ContentCarousel({
  ...
  return (
    <section className="px-3 sm:px-4 md:px-6 lg:px-8">
      <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,hsl(var(--background)/0.78),hsl(var(--background)/0.38))] shadow-[0_10px_32px_rgba(0,0,0,0.26)] p-2 md:p-3">
        {/* Title */}
        {title && (
          <h2 className="px-1 text-xl md:text-2xl font-bold tracking-tight mb-3">
            {title}
          </h2>
        )}
        ...
        <div className="relative group">
          ...
          <Button
            ...
            size="icon"
            onClick={() => scroll("left")}
            className="absolute -left-2 top-1/2 -translate-y-1/2 z-10 bg-background/70 hover:bg-primary/20 hover:text-primary border border-white/15 text-foreground/90 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity hidden md:flex"
          >
          ...
          <Button
            ...
            className="absolute -right-2 top-1/2 -translate-y-1/2 z-10 bg-background/70 hover:bg-primary/20 hover:text-primary border border-white/15 text-foreground/90 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-opacity hidden md:flex"
          >
          ...
          <div
            ref={scrollRef}
            className="flex gap-3 md:gap-4 overflow-x-auto scrollbar-hide scroll-smooth snap-x snap-mandatory px-1 pb-3 md:pb-4"
          >
            {isLoading
              ? // Loading Skeletons
